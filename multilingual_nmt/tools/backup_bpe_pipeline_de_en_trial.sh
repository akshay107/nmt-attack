...
echo "Step 2: Train"
CMD="python $TF/backup_train_trial.py -i $OUT/data --data processed \
...
--pred /home/cvpr/akshay/multilingual_nmt-master/temp/run_de_en/test.out.bpe.reduced.final --out_file output_random_en.txt --label_smoothing 0"
